...
namespace Audex.Infrastructure.Migrations
{
    ...
    [Migration("20260920112151_AddIsinToSecurity")]
    partial class AddIsinToSecurity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Audex.Infrastructure.Entities.Scheduler.ScheduledCronTicker", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Audex.Infrastructure.Entities.Scheduler.ScheduledTaskAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ScheduledTaskAttachment");
                });
            ...
            modelBuilder.Entity("Audex.Infrastructure.Entities.User.UserRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TickerQ.Utilities.Entities.CronTickerOccurrenceEntity<Audex.Infrastructure.Entities.Scheduler.ScheduledCronTicker>", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Audex.Infrastructure.Entities.User.UserRefreshToken", b =>
                {
                    b.HasOne("Audex.Infrastructure.Entities.User.UserRefreshToken", "ReplacedByToken")
                        .WithMany()
            ...
            modelBuilder.Entity("TickerQ.Utilities.Entities.CronTickerOccurrenceEntity<Audex.Infrastructure.Entities.Scheduler.ScheduledCronTicker>", b =>
                {
                    b.HasOne("Audex.Infrastructure.Entities.Scheduler.ScheduledCronTicker", "CronTicker")
